...
* **Pagination** (available in [Pro](https://ays-pro.com/wordpress/photo-gallery)): Organize your images by dividing them into pages. It helps to navigate through larger galleries effortlessly. Besides a smooth browsing experience, it helps to optimize performance with **quicker loading times**.  
...
* Updated: POT file
* Tested: Compatible up to WP 7.1


= 6.8.3 ( Aug 19, 2026 ) =
* Added: Bouncing Entrances in Images hover animation option
...
= 6.8.0 ( Jule 17, 2026 ) =
* Added: Current Gallery Author Registered message variable on the general settings
...
= 6.7.4 ( May 19, 2026 ) =
* Improved: The Gallery admin top banner and improved its responsive layout
* Improved: Some changes on the admin dashboard

= 6.7.3 ( May 12, 2026 ) =
* Added: Suboption to customize mobile settings for the Gallery Thumbnail title icon size option

= 6.7.2 ( April 28, 2026 ) =
* Added: Suboption to customize mobile settings for the Gallery Show caption in lightbox option

= 6.7.1 ( April 23, 2026 ) =
* Fixed: Some issues on the public page

= 6.7.0 ( April 21, 2026 ) =
* Added: Suboption to customize mobile settings for the Gallery Images counter option
* Improved: Some changes on the admin dashboard
...
= 6.6.7 ( March 31, 2026 ) =
* Added: Views tab in the galleries list table

= 6.6.6 ( March 24, 2026 ) =
* Improved: Enhanced HTML sanitization logic in gallery editors
* Improved: Extended allowed HTML tags support (audio, video, etc.)
* Improved: Some changes on the admin dashboard

= 6.6.5 ( March 17, 2026 ) =
* Added: Gallery Display Page URL option

= 6.6.4 ( March 10, 2026 ) =
* Added: Current gallery author nickname message variable on the general settings

= 6.6.3 ( March 03, 2026 ) =
* Added: Category filter in the galleries list table

= 6.6.2 ( February 24, 2026 ) =
* Improved: Some changes on the admin dashboard
* Improved: Styles on the admin dashboard

= 6.6.1 ( February 17, 2026 ) =
* Improved: Some changes on the admin dashboard

= 6.6.0 ( February 11, 2026 ) =
* Improved: Some changes on the admin dashboard
* Updated: POT and Po files

= 6.5.9 ( February 03, 2026 ) =
* Added: Ability to duplicate Image Categories

= 6.5.8 ( January 27, 2026 ) =
* Added: Ability to duplicate Gallery Categories

= 6.5.7 ( January 20, 2026 ) =
* Added: Site Description message variable on the general settings

= 6.5.6 ( January 14, 2026 ) =
* Improved: Some changes on the admin dashboard

= 6.5.5 ( January 08, 2026 ) =
* Added: User Registered message variable on the general settings

= 6.5.4 ( December 24, 2025 ) =
* Improved: Some changes on the admin dashboard

= 6.5.3 ( December 16, 2025 ) =
* Added: Suboption to customize mobile settings for the Gallery Slide duration option

= 6.5.2 ( December 09, 2025 ) =
* Added: Current Month message variable on the general settings

= 6.5.1 ( December 05, 2025 ) =
* Improved: Some changes on the admin dashboard
* Updated: POT and Po files

= 6.5.0 ( December 02, 2025 ) =
* Added: Current Day message variable on the general settings
* Improved: Some changes on the admin dashboard
* Tested: Compatible up to WP 6.9

= 6.4.9 ( November 27, 2025 ) =
* Fixed: Issue in the Gallery list table

= 6.4.8 ( November 25, 2025 ) =
* Improved: Some changes on the admin dashboard

= 6.4.7 ( November 20, 2025 ) =
* Added: "Black Friday Deal" Banner

= 6.4.6 ( November 18, 2025 ) =
* Added: Current Time message variable on the general settings

= 6.4.5 ( November 11, 2025 ) =
* Added: Post author roles message variable on the general settings
* Improved: Some changes on the admin dashboard

= 6.4.4 ( November 04, 2025 ) =
* Improved: Some changes on the admin dashboard
* Updated: POT and Po files

= 6.4.3 ( October 28, 2025 ) =
* Added: Current gallery website url message variable on the general settings
* Improved: Some changes on the admin dashboard

= 6.4.2 ( October 21, 2025 ) =
* Improved: Some changes on the admin dashboard

= 6.4.1 ( October 14, 2025 ) =
* Added: Suboption to customize mobile settings for the Images hover opacity option
* Improved: Some changes on the admin dashboard

= 6.4.0 ( October 08, 2025 ) =
* Improved: Some changes on the admin dashboard

= 6.3.9 ( October 03, 2025 ) =
* Improved: Some changes on the admin dashboard
* Updated: POT and Po files

= 6.3.8 ( September 23, 2025 ) =
* Improved: The banner style on the admin dashboard

= 6.3.7 ( September 16, 2025 ) =
* Added: Suboption to customize mobile settings for the Images border color option

= 6.3.6 ( September 09, 2025 ) =
* Added: Suboption to customize mobile settings for the Images border style option
...
= 6.3.3 ( August 19, 2025 ) =
* Improved: HTML structure for iframe embeds

= 6.3.2 ( August 12, 2025 ) =
* Added: Suboption to customize mobile settings for the Images hover color option
* Improved: Some changes on the admin dashboard

= 6.3.1 ( August 05, 2025 ) =
* Added: Suboption to customize mobile settings for the Show gallery head option

= 6.3.0 ( July 29, 2025 ) =
* Added: Suboption to customize mobile settings for the Enable search for image option
* Fixed: Some issues on the public page and admin dashboard

= 6.2.9 ( July 22, 2025 ) =
* Added: Suboption to customize mobile settings for the hover animation speed option
...
= 6.2.4 ( June 24, 2025 ) =
* Added: Suboption to customize mobile settings for the Images border radius option

= 6.2.3 ( June 17, 2025 ) =
* Added: Suboption to customize mobile settings for the Thumbnail title background color option
* Improved: Some changes on the admin dashboard
...
= 6.1.9 ( May 27, 2025 ) =
* Added: Suboption to customize mobile settings for the Thumbnail title text color option
...
= 6.1.6 =
* Added: Suboption to customize mobile settings for the RTL direction option
...
= 6.1.1 =
* Changed: Subtitle icon on the Galleries List Table
* Improved: Styles on the admin dashboard
...
= 6.0.9 =
* Added: Suboption to customize mobile settings for the Choose filter for thumbnail option

= 6.0.8 =
* Added: Suboption to customize mobile settings for the Gallery Columns count option
* Improved: Some changes on the admin dashboard
...
= 6.0.6 =
* Added: Suboption to customize mobile settings for the Gallery Progress line color option

= 6.0.5 =
* Added: Suboption to customize mobile settings for the Gallery description text color option
...
= 6.0.2 =
* Added: Suboption to customize mobile settings for the Gallery title text color option
...
= 5.8.9 =
* Added: Suboption to customize mobile settings for the Image position option
...
= 5.8.7 =
* Added: Show gallery general category description in a shortcode with a category ID on the general settings

= 5.8.6 =
* Added: Show gallery general category title in a shortcode with a category ID on the general settings

= 5.8.5 =
* Fixed: Gallery category count in the galleries list table
* Improved: Styles on the admin dashboard

= 5.8.4 =
* Added: Expand/Collapse functionality for gallery options on the Galleries page

= 5.8.3 =
* Added: Post ID message variable on the general settings
* Fixed: Masonry view and lazy loading issue on the front page
* Tested: Compatible up to 6.6.2

= 5.8.2 =
* Fixed: Issue connected to Elementor tabs and lazy loading
...
* Fixed: The issue of inserting the image from the WP media library
...
= 5.5.1 =
* Fixed: Filter categories link issue
* Updated: POT and Po files
