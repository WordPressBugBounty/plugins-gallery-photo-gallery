...
class Gallery_Photo_Gallery_Category
{
    ...
    public function __construct($plugin_name, $version){
        ...
        add_shortcode('ays_gallery_general_category_title', array($this, 'ays_generate_gallery_general_categories_title_method'));
        
        add_shortcode('ays_gallery_category_desctription', array($this, 'ays_generate_gallery_categories_description_method'));
        
        add_shortcode('ays_gallery_general_category_desctription', array($this, 'ays_generate_gallery_general_categories_description_method'));
    } 

    /*
    ==========================================
        Show gallery image category title | Start
    ==========================================
    */
    ...
    /*
    ==========================================
        Show gallery image category title | End
    ==========================================
    */

    /*
    ==========================================
        Show gallery general category title | Start
    ==========================================
    */

    public function ays_generate_gallery_general_categories_title_method( $attr ) {

        $id = (isset($attr['id']) && $attr['id'] != '') ? absint( sanitize_text_field($attr['id']) ) : null;
        
        if (is_null($id) || $id == 0 ) {
            $gallery_general_category_title = "";
            return str_replace(array("\r\n", "\n", "\r"), "\n", $gallery_general_category_title);
        }
        ...
        $gallery_general_category_title = $this->ays_gallery_generate_general_cat_title_html( $id );

        return str_replace(array("\r\n", "\n", "\r"), "\n", $gallery_general_category_title);
    }

    public function ays_gallery_generate_general_cat_title_html( $id ) {

        $results = Gallery_Photo_Gallery_Public::get_gallery_general_category_by_id($id);
    ...
    /*
    ==========================================
        Show gallery general category title | End
    ==========================================
    */
    ...
    */
    ...
    /*
    ==========================================
        Show gallery general category description | Start
    ==========================================
    */

    public function ays_generate_gallery_general_categories_description_method( $attr ) {
        ...
        $gallery_category_description = $this->ays_generate_general_cat_description_html( $id );

        return str_replace(array("\r\n", "\n", "\r"), "\n", $gallery_category_description);
    }

    public function ays_generate_general_cat_description_html( $id ) {
        ...
        $general_category_description = ( isset( $results['description'] ) && $results['description'] != '' ) ? Gallery_Photo_Gallery_Public::ays_gallery_autoembed( $results['description'] ) : "";

        if ( $general_category_description == "" ) {
            $content_html = "";
            return $content_html;
        }

        $content_html[] = "<div class='". $this->html_name_prefix ."general-category-description' id='". $this->html_name_prefix ."general-category-description-". $this->unique_id_in_class ."' data-id='". $this->unique_id ."'>";
            $content_html[] = $general_category_description;
        $content_html[] = "</div>";
    ...
    /*
    ==========================================
        Show gallery general category description | End
    ==========================================
    */
