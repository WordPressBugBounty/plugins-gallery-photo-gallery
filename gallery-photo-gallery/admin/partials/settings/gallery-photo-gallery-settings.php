    ...
    <div class="container-fluid">
        <form method="post" class="ays-gpg-general-settings-form">
            ...
            <h1 class="wp-heading-inline">
				<?php
				echo __('Settings', 'gallery-photo-gallery');
				?>
            </h1>
			<?php
                    ...
                    <div id="tab3" class="ays-gpg-tab-content <?php echo ($ays_gpg_tab == 'tab3') ? 'ays-gpg-tab-content-active' : ''; ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <p class="vmessage">
                                    <strong>
                                        <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%current_gallery_author_nickname%%" />
                                    </strong>
                                    <span> - </span>
                                    <span style="font-size:18px;">
                                ...
                                <p class="vmessage">
                                    <strong>
                                        <input type="text" onClick="this.setSelectionRange(0, this.value.length)" readonly value="%%current_gallery_author_registered%%" />
                                    </strong>
                                    <span> - </span>
                                    <span style="font-size:18px;">
                                        <?php echo esc_html__( "Shows the current gallery author's registered date that was filled in their WordPress profile.", 'gallery-photo-gallery'); ?>
                                    </span>
                                </p>
                                <p class="vmessage">
                                    <strong>
			...
			submit_button(__('Save changes', 'gallery-photo-gallery'), 'primary ays-button ays-gpg-save-comp', 'ays_submit', true, $save_bottom_attributes);
            echo $loader_iamge;
			?>
        </form>
    </div>
