<?php
    ...
    switch( $action ) {
        case 'add':
            $heading = __('Add new image category', 'gallery-photo-gallery');
            break;
        case 'edit':
            $heading = __('Edit image category', 'gallery-photo-gallery');
            ...
            <div class="form-group row">
                <div class="col-sm-2">
                    <label for='ays-title'>
                        ...
                        <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__("Title of the image category", 'gallery-photo-gallery' ); ?>">
            ...
            <div class="form-group row">
                <div class="col-sm-2">
                    <label for='ays-description'>
                        ...
                        <a class="ays_help" data-toggle="tooltip" title="<?php echo esc_attr__("Provide more information about the gallery image category", 'gallery-photo-gallery' ); ?>">
                           <i class="fas fa-info-circle"></i>
                        </a>                        
                    </label>
                </div>
