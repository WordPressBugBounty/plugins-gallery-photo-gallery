(function( $ ) {
    ...
    $(document).ready(function (){
        ...
        if ( checkCountdownIsExists.length > 0 ) {
            ...
            // var gpgCountdownEndTime = "DEC 05, 2025 23:59:59";
    ...
    function galleryCopyToClipboard(text) {
        if (navigator.clipboard && window.isSecureContext) {
            navigator.clipboard.writeText(text).then(function() {
                galleryShowCopyNotification(galleryLangObj.successCopyCoupon);
            }).catch(function() {
    ...
    function fallbackCopyTextToClipboard(text) {
        ...
        try {
            ...
            if (successful) {
                ...
                galleryShowCopyNotification(galleryLangObj.failedCopyCoupon);
            }
        } catch (err) {
            galleryShowCopyNotification(galleryLangObj.failedCopyCoupon);
        }
    ...
    function galleryShowCopyNotification(message) {
        var notification = document.createElement("div");
        notification.className = "ays-gpg-copy-notification show";
